...
const Page = () => {
  ...
  return (
    <main className="flex flex-col h-svh max-h-svh overflow-hidden bg-background text-foreground">
      <DestructModal
      ...
      />
      <header className="relative border-b border-border p-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-0 bg-surface/30">
        <div className="flex items-center justify-between w-full sm:contents">
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2">
                <span className="font-bold text-accent">{roomId}</span>
                {status !== "connected" && (
                  <span
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-[10px] bg-surface-elevated hover:bg-border px-2 py-1 rounded text-muted hover:text-foreground transition-colors cursor-pointer"
                >
                  {copied ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs border border-border hover:border-border-strong text-muted hover:text-foreground px-3 py-2 rounded transition-colors cursor-pointer"
      ...
      <div className="p-4 pb-[env(safe-area-inset-bottom)] border-t border-border bg-surface/30">
        <div className="flex gap-2 sm:gap-4">
          <div className="flex-1 relative group text-wrap">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-accent animate-pulse">
              {">"}
            </span>
            <input
          ...
          <button
            ...
            className="bg-surface-elevated px-6 min-h-[44px] min-w-[44px] transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:bg-border"
          >

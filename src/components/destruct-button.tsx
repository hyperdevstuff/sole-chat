...
export function DestructButton({
  ...
  return (
    <button
      ...
      className="relative flex h-10 items-center gap-2 rounded-full bg-surface-elevated px-8 font-medium text-muted select-none transition-transform cursor-pointer min-w-[140px] sm:min-w-[180px] justify-center"
      style={{

...
export function DestructButton({
  ...
  return (
    <button
      ...
      className="relative flex h-10 items-center gap-2 rounded-full bg-neutral-800 px-6 font-medium text-neutral-300 select-none transition-transform cursor-pointer"
      style={{
    ...
    >
      ...
      {/* hover text - only visible on hover, hidden when holding */}

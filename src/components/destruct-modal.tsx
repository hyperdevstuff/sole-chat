      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-danger-subtle hover:bg-danger-subtle-hover border border-danger-subtle-border text-danger-subtle-foreground rounded-lg font-medium text-sm transition-colors cursor-pointer"
          >
            Just Destroy
          </button>
        </div>

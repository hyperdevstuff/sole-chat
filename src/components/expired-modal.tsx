      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-surface-elevated hover:bg-border border border-border text-foreground rounded-lg font-medium text-sm transition-colors cursor-pointer"
          >
            Create New Room
          </button>
        </div>
